...
Usage:
    from v6.workflows import ExitWorkflow
    from v6.decisions import Decision, DecisionAction
...
from v6.system_monitor.execution_engine.models import ExecutionResult
...
try:
    from v6.risk import TrailingStopManager
except ImportError:
...
class ExitWorkflow:
    ...
    **Integration:**
    ...
    def _execution_to_strategy(self, execution: StrategyExecution) -> Strategy:
        ...
        """
        from v6.strategy_builder.models import LegAction, LegSpec
