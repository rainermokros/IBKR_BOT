...
from v6.system_monitor.dashboard.components.greeks_display import (
...
from v6.system_monitor.dashboard.data.portfolio import (
...
def get_available_symbols() -> list[str]:
    ...
    from v6.system_monitor.dashboard.data.positions import get_available_symbols
